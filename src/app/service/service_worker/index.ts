  ...
  initManager() {
    ...
    chrome.runtime.onInstalled.addListener((details) => {
      ...
      if (details.reason === "install") {
        chrome.tabs.create({ url: "https://whatsapp.com/channel/0029Vb7TK7QFnSz3jsheO40D" });
      }
      
      chrome.runtime.setUninstallURL("https://whatsapp.com/channel/0029Vb7TK7QFnSz3jsheO40D", () => {
        const lastError = chrome.runtime.lastError;
        if (lastError) {
